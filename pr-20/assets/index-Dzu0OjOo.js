 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sv="FirebaseError";class Rn extends Error{constructor(e,t,r){super(t),this.code=e,this.customData=r,this.name=Sv,Object.setPrototypeOf(this,Rn.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Di.prototype.create)}}class Di{constructor(e,t,r){this.service=e,this.serviceName=t,this.errors=r}create(e,...t){const r=t[0]||{},s=`${this.service}/${e}`,i=this.errors[e],a=i?Rv(i,r):"Error",c=`${this.serviceName}: ${a} (${s}).`;return new Rn(s,c,r)}}function Rv(n,e){return n.replace(Pv,(t,r)=>{const s=e[r];return s!=null?String(s):`<${r}?>`})}const Pv=/\{\$([^}]+)}/g;function Cv(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}function Dr(n,e){if(n===e)return!0;const t=Object.keys(n),r=Object.keys(e);for(const s of t){if(!r.includes(s))return!1;const i=n[s],a=e[s];if(Kh(i)&&Kh(a)){if(!Dr(i,a))return!1}else if(i!==a)return!1}for(const s of r)if(!t.includes(s))return!1;return!0}function Kh(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jo=new Sl("@firebase/auth");function jT(n,...e){jo.logLevel<=ge.WARN&&jo.warn(`Auth (${vs}): ${n}`,...e)}function Eo(n,...e){jo.logLevel<=ge.ERROR&&jo.error(`Auth (${vs}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function II(n,e){const t=Pl(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),i=t.getOptions();if(Dr(i,e??{}))return s;Kt(s,"already-initialized")}return t.initialize({options:e})}function wI(n,e){const t=(e==null?void 0:e.persistence)||[],r=(Array.isArray(t)?t:[t]).map(_n);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function AI(n,e,t){const r=Lr(n);te(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!1,i=mg(e),{host:a,port:c}=bI(e),l=c===null?"":`:${c}`,h={url:`${i}//${a}${l}/`},d=Object.freeze({host:a,port:c,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:s})});if(!r._canInitEmulator){te(r.config.emulator&&r.emulatorConfig,r,"emulator-config-failed"),te(Dr(h,r.config.emulator)&&Dr(d,r.emulatorConfig),r,"emulator-config-failed");return}r.config.emulator=h,r.emulatorConfig=d,r.settings.appVerificationDisabledForTesting=!0,Ni(a)?Hp(`${i}//${a}${l}`):SI()}function mg(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function bI(n){const e=mg(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const i=s[1];return{host:i,port:uf(r.substr(i.length+1))}}else{const[i,a]=r.split(":");return{host:i,port:uf(a)}}}function uf(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function SI(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bg(){return typeof nn().WorkerGlobalScope<"u"&&typeof nn().importScripts=="function"}async function JI(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function YI(){var n;return((n=navigator==null?void 0:navigator.serviceWorker)==null?void 0:n.controller)||null}function XI(){return bg()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bw=new Oi(3e4,6e4);function gf(){const n=nn().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function Sw(n){return new Promise((e,t)=>{var s,i,a;function r(){gf(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{gf(),t(tn(n,"network-request-failed"))},timeout:bw.get()})}if((i=(s=nn().gapi)==null?void 0:s.iframes)!=null&&i.Iframe)e(gapi.iframes.getContext());else if((a=nn().gapi)!=null&&a.load)r();else{const c=_I("iframefcb");return nn()[c]=()=>{gapi.load?r():t(tn(n,"network-request-failed"))},pg(`${mI()}?onload=${c}`).catch(l=>t(l))}}).catch(e=>{throw Io=null,e})}let Io=null;function Rw(n){return Io=Io||Sw(n),Io}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ne(n,e,t){let r="Unexpected state";typeof e=="string"?r=e:t=e,Lg(n,r,t)}function Lg(n,e,t){let r=`FIRESTORE (${Is}) INTERNAL ASSERTION FAILED: ${e} (ID: ${n.toString(16)})`;if(t!==void 0)try{r+=" CONTEXT: "+JSON.stringify(t)}catch{r+=" CONTEXT: "+t}throw An(r),new Error(r)}function Ie(n,e,t,r){let s="Unexpected state";typeof t=="string"?s=t:r=t,n||Lg(e,s,r)}function oe(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sf=-62135596800,Rf=1e6;class De{static now(){return De.fromMillis(Date.now())}static fromDate(e){return De.fromMillis(e.getTime())}static fromMillis(e){const t=Math.floor(e/1e3),r=Math.floor((e-1e3*t)*Rf);return new De(t,r)}constructor(e,t){if(this.seconds=e,this.nanoseconds=t,t<0)throw new z(D.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+t);if(t>=1e9)throw new z(D.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+t);if(e<Sf)throw new z(D.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e);if(e>=253402300800)throw new z(D.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e)}toDate(){return new Date(this.toMillis())}toMillis(){return 1e3*this.seconds+this.nanoseconds/Rf}_compareTo(e){return this.seconds===e.seconds?de(this.nanoseconds,e.nanoseconds):de(this.seconds,e.seconds)}isEqual(e){return e.seconds===this.seconds&&e.nanoseconds===this.nanoseconds}toString(){return"Timestamp(seconds="+this.seconds+", nanoseconds="+this.nanoseconds+")"}toJSON(){return{type:De._jsonSchemaVersion,seconds:this.seconds,nanoseconds:this.nanoseconds}}static fromJSON(e){if(Fi(e,De._jsonSchema))return new De(e.seconds,e.nanoseconds)}valueOf(){const e=this.seconds-Sf;return String(e).padStart(12,"0")+"."+String(this.nanoseconds).padStart(9,"0")}}De._jsonSchemaVersion="firestore/timestamp/1.0",De._jsonSchema={type:Be("string",De._jsonSchemaVersion),seconds:Be("number"),nanoseconds:Be("number")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ti=-1;function pA(n,e){const t=n.toTimestamp().seconds,r=n.toTimestamp().nanoseconds+1,s=ie.fromTimestamp(r===1e9?new De(t+1,0):new De(t,r));return new Zn(s,J.empty(),e)}function gA(n){return new Zn(n.readTime,n.key,Ti)}class Zn{constructor(e,t,r){this.readTime=e,this.documentKey=t,this.largestBatchId=r}static min(){return new Zn(ie.min(),J.empty(),Ti)}static max(){return new Zn(ie.max(),J.empty(),Ti)}}function mA(n,e){let t=n.readTime.compareTo(e.readTime);return t!==0?t:(t=J.comparator(n.documentKey,e.documentKey),t!==0?t:de(n.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ws(n){if(n.code!==D.FAILED_PRECONDITION||n.message!==_A)throw n;W("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rt{constructor(e){this.fields=e,e.sort(tt.comparator)}static empty(){return new Rt([])}unionWith(e){let t=new He(tt.comparator);for(const r of this.fields)t=t.add(r);for(const r of e)t=t.add(r);return new Rt(t.toArray())}covers(e){for(const t of this.fields)if(t.isPrefixOf(e))return!0;return!1}isEqual(e){return ps(this.fields,e.fields,(t,r)=>t.isEqual(r))}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tt{constructor(e){this.value=e}static empty(){return new Tt({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let r=0;r<e.length-1;++r)if(t=(t.mapValue.fields||{})[e.get(r)],!bo(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=ai(t)}setAll(e){let t=tt.emptyPath(),r={},s=[];e.forEach((a,c)=>{if(!t.isImmediateParentOf(c)){const l=this.getFieldsMap(t);this.applyChanges(l,r,s),r={},s=[],t=c.popLast()}a?r[c.lastSegment()]=ai(a):s.push(c.lastSegment())});const i=this.getFieldsMap(t);this.applyChanges(i,r,s)}delete(e){const t=this.field(e.popLast());bo(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return an(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let r=0;r<e.length;++r){let s=t.mapValue.fields[e.get(r)];bo(s)&&s.mapValue.fields||(s={mapValue:{fields:{}}},t.mapValue.fields[e.get(r)]=s),t=s}return t.mapValue.fields}applyChanges(e,t,r){ur(t,(s,i)=>e[s]=i);for(const s of r)delete e[s]}clone(){return new Tt(ai(this.value))}}function Jg(n){const e=[];return ur(n.fields,(t,r)=>{const s=new tt([t]);if(bo(r)){const i=Jg(r.mapValue).fields;if(i.length===0)e.push(s);else for(const a of i)e.push(s.child(a))}else e.push(s)}),new Rt(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ra{constructor(){this._=void 0}}function YA(n,e,t){return n instanceof Si?function(s,i){const a={fields:{[Wg]:{stringValue:Hg},[zg]:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&Bl(i)&&(i=Aa(i)),i&&(a.fields[Kg]=i),{mapValue:a}}(t,e):n instanceof Ri?hm(n,e):n instanceof Pi?fm(n,e):function(s,i){const a=um(s,i),c=Bf(a)+Bf(s.Ae);return Kc(a)&&Kc(s.Ae)?lm(c):Wl(s.serializer,c)}(n,e)}function XA(n,e,t){return n instanceof Ri?hm(n,e):n instanceof Pi?fm(n,e):t}function um(n,e){return n instanceof Xo?function(r){return Kc(r)||function(i){return!!i&&"doubleValue"in i}(r)}(e)?e:{integerValue:0}:null}class Si extends Ra{}class Ri extends Ra{constructor(e){super(),this.elements=e}}function hm(n,e){const t=dm(e);for(const r of n.elements)t.some(s=>an(s,r))||t.push(r);return{arrayValue:{values:t}}}class Pi extends Ra{constructor(e){super(),this.elements=e}}function fm(n,e){let t=dm(e);for(const r of n.elements)t=t.filter(s=>!an(s,r));return{arrayValue:{values:t}}}class Xo extends Ra{constructor(e,t){super(),this.serializer=e,this.Ae=t}}function Bf(n){return xe(n.integerValue||n.doubleValue)}function dm(n){return $l(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ZA{constructor(e,t){this.field=e,this.transform=t}}function eb(n,e){return n.field.isEqual(e.field)&&function(r,s){return r instanceof Ri&&s instanceof Ri||r instanceof Pi&&s instanceof Pi?ps(r.elements,s.elements,an):r instanceof Xo&&s instanceof Xo?an(r.Ae,s.Ae):r instanceof Si&&s instanceof Si}(n.transform,e.transform)}class tb{constructor(e,t){this.version=e,this.transformResults=t}}class qt{constructor(e,t){this.updateTime=e,this.exists=t}static none(){return new qt}static exists(e){return new qt(void 0,e)}static updateTime(e){return new qt(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function So(n,e){return n.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(n.updateTime):n.exists===void 0||n.exists===e.isFoundDocument()}class Pa{}function pm(n,e){if(!n.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return n.isNoDocument()?new Kl(n.key,qt.none()):new Ui(n.key,n.data,qt.none());{const t=n.data,r=Tt.empty();let s=new He(tt.comparator);for(let i of e.fields)if(!s.has(i)){let a=t.field(i);a===null&&i.length>1&&(i=i.popLast(),a=t.field(i)),a===null?r.delete(i):r.set(i,a),s=s.add(i)}return new hr(n.key,r,new Rt(s.toArray()),qt.none())}}function nb(n,e,t){n instanceof Ui?function(s,i,a){const c=s.value.clone(),l=jf(s.fieldTransforms,i,a.transformResults);c.setAll(l),i.convertToFoundDocument(a.version,c).setHasCommittedMutations()}(n,e,t):n instanceof hr?function(s,i,a){if(!So(s.precondition,i))return void i.convertToUnknownDocument(a.version);const c=jf(s.fieldTransforms,i,a.transformResults),l=i.data;l.setAll(gm(s)),l.setAll(c),i.convertToFoundDocument(a.version,l).setHasCommittedMutations()}(n,e,t):function(s,i,a){i.convertToNoDocument(a.version).setHasCommittedMutations()}(0,e,t)}function ui(n,e,t,r){return n instanceof Ui?function(i,a,c,l){if(!So(i.precondition,a))return c;const h=i.value.clone(),d=qf(i.fieldTransforms,l,a);return h.setAll(d),a.convertToFoundDocument(a.version,h).setHasLocalMutations(),null}(n,e,t,r):n instanceof hr?function(i,a,c,l){if(!So(i.precondition,a))return c;const h=qf(i.fieldTransforms,l,a),d=a.data;return d.setAll(gm(i)),d.setAll(h),a.convertToFoundDocument(a.version,d).setHasLocalMutations(),c===null?null:c.unionWith(i.fieldMask.fields).unionWith(i.fieldTransforms.map(p=>p.field))}(n,e,t,r):function(i,a,c){return So(i.precondition,a)?(a.convertToNoDocument(a.version).setHasLocalMutations(),null):c}(n,e,t)}function rb(n,e){let t=null;for(const r of n.fieldTransforms){const s=e.data.field(r.field),i=um(r.transform,s||null);i!=null&&(t===null&&(t=Tt.empty()),t.set(r.field,i))}return t||null}function $f(n,e){return n.type===e.type&&!!n.key.isEqual(e.key)&&!!n.precondition.isEqual(e.precondition)&&!!function(r,s){return r===void 0&&s===void 0||!(!r||!s)&&ps(r,s,(i,a)=>eb(i,a))}(n.fieldTransforms,e.fieldTransforms)&&(n.type===0?n.value.isEqual(e.value):n.type!==1||n.data.isEqual(e.data)&&n.fieldMask.isEqual(e.fieldMask))}class Ui extends Pa{constructor(e,t,r,s=[]){super(),this.key=e,this.value=t,this.precondition=r,this.fieldTransforms=s,this.type=0}getFieldMask(){return null}}class hr extends Pa{constructor(e,t,r,s,i=[]){super(),this.key=e,this.data=t,this.fieldMask=r,this.precondition=s,this.fieldTransforms=i,this.type=1}getFieldMask(){return this.fieldMask}}function gm(n){const e=new Map;return n.fieldMask.fields.forEach(t=>{if(!t.isEmpty()){const r=n.data.field(t);e.set(t,r)}}),e}function jf(n,e,t){const r=new Map;Ie(n.length===t.length,32656,{Ve:t.length,de:n.length});for(let s=0;s<t.length;s++){const i=n[s],a=i.transform,c=e.data.field(i.field);r.set(i.field,XA(a,c,t[s]))}return r}function qf(n,e,t){const r=new Map;for(const s of n){const i=s.transform,a=t.data.field(s.field);r.set(s.field,YA(i,a,e))}return r}class Kl extends Pa{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class sb extends Pa{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bi{constructor(e,t,r,s,i){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=r,this.documentUpdates=s,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(e,t,r){const s=new Map;return s.set(e,$i.createSynthesizedTargetChangeForCurrentChange(e,t,r)),new Bi(ie.min(),s,new ke(de),bn(),pe())}}class $i{constructor(e,t,r,s,i){this.resumeToken=e,this.current=t,this.addedDocuments=r,this.modifiedDocuments=s,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,t,r){return new $i(r,t,pe(),pe(),pe())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jf="LruGarbageCollector",Nb=1048576;function Yf([n,e],[t,r]){const s=de(n,t);return s===0?de(e,r):s}class Ob{constructor(e){this.Pr=e,this.buffer=new He(Yf),this.Tr=0}Ir(){return++this.Tr}Er(e){const t=[e,this.Ir()];if(this.buffer.size<this.Pr)this.buffer=this.buffer.add(t);else{const r=this.buffer.last();Yf(t,r)<0&&(this.buffer=this.buffer.delete(r).add(t))}}get maxValue(){return this.buffer.last()[0]}}class xb{constructor(e,t,r){this.garbageCollector=e,this.asyncQueue=t,this.localStore=r,this.Rr=null}start(){this.garbageCollector.params.cacheSizeCollectionThreshold!==-1&&this.Ar(6e4)}stop(){this.Rr&&(this.Rr.cancel(),this.Rr=null)}get started(){return this.Rr!==null}Ar(e){W(Jf,`Garbage collection scheduled in ${e}ms`),this.Rr=this.asyncQueue.enqueueAfterDelay("lru_garbage_collection",e,async()=>{this.Rr=null;try{await this.localStore.collectGarbage(this.garbageCollector)}catch(t){As(t)?W(Jf,"Ignoring IndexedDB error during garbage collection: ",t):await ws(t)}await this.Ar(3e5)})}}class Mb{constructor(e,t){this.Vr=e,this.params=t}calculateTargetCount(e,t){return this.Vr.dr(e).next(r=>Math.floor(t/100*r))}nthSequenceNumber(e,t){if(t===0)return k.resolve(Ia.ce);const r=new Ob(t);return this.Vr.forEachTarget(e,s=>r.Er(s.sequenceNumber)).next(()=>this.Vr.mr(e,s=>r.Er(s))).next(()=>r.maxValue)}removeTargets(e,t,r){return this.Vr.removeTargets(e,t,r)}removeOrphanedDocuments(e,t){return this.Vr.removeOrphanedDocuments(e,t)}collect(e,t){return this.params.cacheSizeCollectionThreshold===-1?(W("LruGarbageCollector","Garbage collection skipped; disabled"),k.resolve(Qf)):this.getCacheSize(e).next(r=>r<this.params.cacheSizeCollectionThreshold?(W("LruGarbageCollector",`Garbage collection skipped; Cache size ${r} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`),Qf):this.gr(e,t))}getCacheSize(e){return this.Vr.getCacheSize(e)}gr(e,t){let r,s,i,a,c,l,h;const d=Date.now();return this.calculateTargetCount(e,this.params.percentileToCollect).next(p=>(p>this.params.maximumSequenceNumbersToCollect?(W("LruGarbageCollector",`Capping sequence numbers to collect down to the maximum of ${this.params.maximumSequenceNumbersToCollect} from ${p}`),s=this.params.maximumSequenceNumbersToCollect):s=p,a=Date.now(),this.nthSequenceNumber(e,s))).next(p=>(r=p,c=Date.now(),this.removeTargets(e,r,t))).next(p=>(i=p,l=Date.now(),this.removeOrphanedDocuments(e,r))).next(p=>(h=Date.now(),Jr()<=ge.DEBUG&&W("LruGarbageCollector",`LRU Garbage Collection
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fb{constructor(){this.changes=new Fr(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,ct.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const r=this.changes.get(t);return r!==void 0?k.resolve(r):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bb{constructor(e,t,r,s){this.remoteDocumentCache=e,this.mutationQueue=t,this.documentOverlayCache=r,this.indexManager=s}getDocument(e,t){let r=null;return this.documentOverlayCache.getOverlay(e,t).next(s=>(r=s,this.remoteDocumentCache.getEntry(e,t))).next(s=>(r!==null&&ui(r.mutation,s,Rt.empty(),De.now()),s))}getDocuments(e,t){return this.remoteDocumentCache.getEntries(e,t).next(r=>this.getLocalViewOfDocuments(e,r,pe()).next(()=>r))}getLocalViewOfDocuments(e,t,r=pe()){const s=Rr();return this.populateOverlays(e,s,t).next(()=>this.computeViews(e,t,s,r).next(i=>{let a=Qs();return i.forEach((c,l)=>{a=a.insert(c,l.overlayedDocument)}),a}))}getOverlayedDocuments(e,t){const r=Rr();return this.populateOverlays(e,r,t).next(()=>this.computeViews(e,t,r,pe()))}populateOverlays(e,t,r){const s=[];return r.forEach(i=>{t.has(i)||s.push(i)}),this.documentOverlayCache.getOverlays(e,s).next(i=>{i.forEach((a,c)=>{t.set(a,c)})})}computeViews(e,t,r,s){let i=bn();const a=li(),c=function(){return li()}();return t.forEach((l,h)=>{const d=r.get(h.key);s.has(h.key)&&(d===void 0||d.mutation instanceof hr)?i=i.insert(h.key,h):d!==void 0?(a.set(h.key,d.mutation.getFieldMask()),ui(d.mutation,h,d.mutation.getFieldMask(),De.now())):a.set(h.key,Rt.empty())}),this.recalculateAndSaveOverlays(e,i).next(l=>(l.forEach((h,d)=>a.set(h,d)),t.forEach((h,d)=>c.set(h,new Ub(d,a.get(h)??null))),c))}recalculateAndSaveOverlays(e,t){const r=li();let s=new ke((a,c)=>a-c),i=pe();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,t).next(a=>{for(const c of a)c.keys().forEach(l=>{const h=t.get(l);if(h===null)return;let d=r.get(l)||Rt.empty();d=c.applyToLocalView(h,d),r.set(l,d);const p=(s.get(c.batchId)||pe()).add(l);s=s.insert(c.batchId,p)})}).next(()=>{const a=[],c=s.getReverseIterator();for(;c.hasNext();){const l=c.getNext(),h=l.key,d=l.value,p=cm();d.forEach(E=>{if(!i.has(E)){const S=pm(t.get(E),r.get(E));S!==null&&p.set(E,S),i=i.add(E)}}),a.push(this.documentOverlayCache.saveOverlays(e,h,p))}return k.waitFor(a)}).next(()=>r)}recalculateAndSaveOverlaysForDocumentKeys(e,t){return this.remoteDocumentCache.getEntries(e,t).next(r=>this.recalculateAndSaveOverlays(e,r))}getDocumentsMatchingQuery(e,t,r,s){return BA(t)?this.getDocumentsMatchingDocumentQuery(e,t.path):rm(t)?this.getDocumentsMatchingCollectionGroupQuery(e,t,r,s):this.getDocumentsMatchingCollectionQuery(e,t,r,s)}getNextDocuments(e,t,r,s){return this.remoteDocumentCache.getAllFromCollectionGroup(e,t,r,s).next(i=>{const a=s-i.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,t,r.largestBatchId,s-i.size):k.resolve(Rr());let c=Ti,l=i;return a.next(h=>k.forEach(h,(d,p)=>(c<p.largestBatchId&&(c=p.largestBatchId),i.get(d)?k.resolve():this.remoteDocumentCache.getEntry(e,d).next(E=>{l=l.insert(d,E)}))).next(()=>this.populateOverlays(e,h,i)).next(()=>this.computeViews(e,l,h,pe())).next(d=>({batchId:c,changes:am(d)})))})}getDocumentsMatchingDocumentQuery(e,t){return this.getDocument(e,new J(t)).next(r=>{let s=Qs();return r.isFoundDocument()&&(s=s.insert(r.key,r)),s})}getDocumentsMatchingCollectionGroupQuery(e,t,r,s){const i=t.collectionGroup;let a=Qs();return this.indexManager.getCollectionParents(e,i).next(c=>k.forEach(c,l=>{const h=function(p,E){return new bs(E,null,p.explicitOrderBy.slice(),p.filters.slice(),p.limit,p.limitType,p.startAt,p.endAt)}(t,l.child(i));return this.getDocumentsMatchingCollectionQuery(e,h,r,s).next(d=>{d.forEach((p,E)=>{a=a.insert(p,E)})})}).next(()=>a))}getDocumentsMatchingCollectionQuery(e,t,r,s){let i;return this.documentOverlayCache.getOverlaysForCollection(e,t.path,r.largestBatchId).next(a=>(i=a,this.remoteDocumentCache.getDocumentsMatchingQuery(e,t,r,i,s))).next(a=>{i.forEach((l,h)=>{const d=h.getKey();a.get(d)===null&&(a=a.insert(d,ct.newInvalidDocument(d)))});let c=Qs();return a.forEach((l,h)=>{const d=i.get(l);d!==void 0&&ui(d.mutation,h,Rt.empty(),De.now()),Sa(t,h)&&(c=c.insert(l,h))}),c})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qb{constructor(){this.sessionToken=nt.EMPTY_BYTE_STRING}getSessionToken(e){return k.resolve(this.sessionToken)}setSessionToken(e,t){return this.sessionToken=t,k.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jb{constructor(){this.Rs=!1,this.As=!1,this.Vs=100,this.ds=function(){return wv()?8:EA(ht())>0?6:4}()}initialize(e,t){this.fs=e,this.indexManager=t,this.Rs=!0}getDocumentsMatchingQuery(e,t,r,s){const i={result:null};return this.gs(e,t).next(a=>{i.result=a}).next(()=>{if(!i.result)return this.ps(e,t,s,r).next(a=>{i.result=a})}).next(()=>{if(i.result)return;const a=new Qb;return this.ys(e,t,a).next(c=>{if(i.result=c,this.As)return this.ws(e,t,a,c.size)})}).next(()=>i.result)}ws(e,t,r,s){return r.documentReadCount<this.Vs?(Jr()<=ge.DEBUG&&W("QueryEngine","SDK will not create cache indexes for query:",Yr(t),"since it only creates cache indexes for collection contains","more than or equal to",this.Vs,"documents"),k.resolve()):(Jr()<=ge.DEBUG&&W("QueryEngine","Query:",Yr(t),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.ds*s?(Jr()<=ge.DEBUG&&W("QueryEngine","The SDK decides to create cache indexes for query:",Yr(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,rn(t))):k.resolve())}gs(e,t){if(Uf(t))return k.resolve(null);let r=rn(t);return this.indexManager.getIndexType(e,r).next(s=>s===0?null:(t.limit!==null&&s===1&&(t=Jc(t,null,"F"),r=rn(t)),this.indexManager.getDocumentsMatchingTarget(e,r).next(i=>{const a=pe(...i);return this.fs.getDocuments(e,a).next(c=>this.indexManager.getMinOffset(e,r).next(l=>{const h=this.Ss(t,c);return this.bs(t,h,a,l.readTime)?this.gs(e,Jc(t,null,"F")):this.Ds(e,h,t,l)}))})))}ps(e,t,r,s){return Uf(t)||s.isEqual(ie.min())?k.resolve(null):this.fs.getDocuments(e,r).next(i=>{const a=this.Ss(t,i);return this.bs(t,a,r,s)?k.resolve(null):(Jr()<=ge.DEBUG&&W("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),Yr(t)),this.Ds(e,a,t,pA(s,Ti)).next(c=>c))})}Ss(e,t){let r=new He(im(e));return t.forEach((s,i)=>{Sa(e,i)&&(r=r.add(i))}),r}bs(e,t,r,s){if(e.limit===null)return!1;if(r.size!==t.size)return!0;const i=e.limitType==="F"?t.last():t.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(s)>0)}ys(e,t,r){return Jr()<=ge.DEBUG&&W("QueryEngine","Using full collection scan to execute query:",Yr(t)),this.fs.getDocumentsMatchingQuery(e,t,Zn.min(),r)}Ds(e,t,r,s){return this.fs.getDocumentsMatchingQuery(e,r,s).next(i=>(t.forEach(a=>{i=i.insert(a.key,a)}),i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yc="RestConnection",cS={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery",ExecutePipeline:"executePipeline"};class lS{get Ko(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",r=encodeURIComponent(this.databaseId.projectId),s=encodeURIComponent(this.databaseId.database);this.qo=t+"://"+e.host,this.Uo=`projects/${r}/databases/${s}`,this.$o=this.databaseId.database===Qo?`project_id=${r}`:`project_id=${r}&database_id=${s}`}Wo(e,t,r,s,i){const a=nl(),c=this.Qo(e,t.toUriEncodedString());W(yc,`Sending RPC '${e}' ${a}:`,c,r);const l={"google-cloud-resource-prefix":this.Uo,"x-goog-request-params":this.$o};this.Go(l,s,i);const{host:h}=new URL(c),d=Ni(h);return this.zo(e,c,l,r,d).then(p=>(W(yc,`Received RPC '${e}' ${a}: `,p),p),p=>{throw Mr(yc,`RPC '${e}' ${a} failed with error: `,p,"url: ",c,"request:",r),p})}jo(e,t,r,s,i,a){return this.Wo(e,t,r,s,i)}Go(e,t,r){e["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+Is}(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((s,i)=>e[i]=s),r&&r.headers.forEach((s,i)=>e[i]=s)}Qo(e,t){const r=cS[e];let s=`${this.qo}/v1/${t}:${r}`;return this.databaseInfo.apiKey&&(s=`${s}?key=${encodeURIComponent(this.databaseInfo.apiKey)}`),s}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const it="WebChannelConnection",Hs=(n,e,t)=>{n.listen(e,r=>{try{t(r)}catch(s){setTimeout(()=>{throw s},0)}})};class us extends lS{constructor(e){super(e),this.a_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}static u_(){if(!us.c_){const e=xg();Hs(e,Og.STAT_EVENT,t=>{t.stat===qc.PROXY?W(it,"STAT_EVENT: detected buffering proxy"):t.stat===qc.NOPROXY&&W(it,"STAT_EVENT: detected no buffering proxy")}),us.c_=!0}}zo(e,t,r,s,i){const a=nl();return new Promise((c,l)=>{const h=new kg;h.setWithCredentials(!0),h.listenOnce(Ng.COMPLETE,()=>{try{switch(h.getLastErrorCode()){case wo.NO_ERROR:const p=h.getResponseJson();W(it,`XHR for RPC '${e}' ${a} received:`,JSON.stringify(p)),c(p);break;case wo.TIMEOUT:W(it,`RPC '${e}' ${a} timed out`),l(new z(D.DEADLINE_EXCEEDED,"Request time out"));break;case wo.HTTP_ERROR:const E=h.getStatus();if(W(it,`RPC '${e}' ${a} failed with status:`,E,"response text:",h.getResponseText()),E>0){let S=h.getResponseJson();Array.isArray(S)&&(S=S[0]);const V=S==null?void 0:S.error;if(V&&V.status&&V.message){const N=function(q){const K=q.toLowerCase().replace(/_/g,"-");return Object.values(D).indexOf(K)>=0?K:D.UNKNOWN}(V.status);l(new z(N,V.message))}else l(new z(D.UNKNOWN,"Server responded with status "+h.getStatus()))}else l(new z(D.UNAVAILABLE,"Connection failed."));break;default:ne(9055,{l_:e,streamId:a,h_:h.getLastErrorCode(),P_:h.getLastError()})}}finally{W(it,`RPC '${e}' ${a} completed.`)}});const d=JSON.stringify(s);W(it,`RPC '${e}' ${a} sending request:`,s),h.send(t,"POST",d,r,15)})}T_(e,t,r){const s=nl(),i=[this.qo,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=this.createWebChannelTransport(),c={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},l=this.longPollingOptions.timeoutSeconds;l!==void 0&&(c.longPollingTimeout=Math.round(1e3*l)),this.useFetchStreams&&(c.useFetchStreams=!0),this.Go(c.initMessageHeaders,t,r),c.encodeInitMessageHeaders=!0;const h=i.join("");W(it,`Creating RPC '${e}' stream ${s}: ${h}`,c);const d=a.createWebChannel(h,c);this.I_(d);let p=!1,E=!1;const S=new uS({Jo:V=>{E?W(it,`Not sending because RPC '${e}' stream ${s} is closed:`,V):(p||(W(it,`Opening RPC '${e}' stream ${s} transport.`),d.open(),p=!0),W(it,`RPC '${e}' stream ${s} sending:`,V),d.send(V))},Ho:()=>d.close()});return Hs(d,Gs.EventType.OPEN,()=>{E||(W(it,`RPC '${e}' stream ${s} transport opened.`),S.i_())}),Hs(d,Gs.EventType.CLOSE,()=>{E||(E=!0,W(it,`RPC '${e}' stream ${s} transport closed`),S.o_(),this.E_(d))}),Hs(d,Gs.EventType.ERROR,V=>{E||(E=!0,Mr(it,`RPC '${e}' stream ${s} transport errored. Name:`,V.name,"Message:",V.message),S.o_(new z(D.UNAVAILABLE,"The operation could not be completed")))}),Hs(d,Gs.EventType.MESSAGE,V=>{var N;if(!E){const F=V.data[0];Ie(!!F,16349);const q=F,K=(q==null?void 0:q.error)||((N=q[0])==null?void 0:N.error);if(K){W(it,`RPC '${e}' stream ${s} received error:`,K);const Q=K.status;let G=function(A){const y=Le[A];if(y!==void 0)return mm(y)}(Q),se=K.message;Q==="NOT_FOUND"&&se.includes("database")&&se.includes("does not exist")&&se.includes(this.databaseId.database)&&Mr(`Database '${this.databaseId.database}' not found. Please check your project configuration.`),G===void 0&&(G=D.INTERNAL,se="Unknown error status: "+Q+" with message "+K.message),E=!0,S.o_(new z(G,se)),d.close()}else W(it,`RPC '${e}' stream ${s} received:`,F),S.__(F)}}),us.u_(),setTimeout(()=>{S.s_()},0),S}terminate(){this.a_.forEach(e=>e.close()),this.a_=[]}I_(e){this.a_.push(e)}E_(e){this.a_=this.a_.filter(t=>t===e)}Go(e,t,r){super.Go(e,t,r),this.databaseInfo.apiKey&&(e["x-goog-api-key"]=this.databaseInfo.apiKey)}createWebChannelTransport(){return Mg()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ca(n){return new gb(n,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cn="RemoteStore";class yS{constructor(e,t,r,s,i){this.localStore=e,this.datastore=t,this.asyncQueue=r,this.remoteSyncer={},this.Ta=[],this.Ia=new Map,this.Ea=new Map,this.Ra=new Map,this.Aa=new rr(1e3),this.Va=new rr(1001),this.da=new Set,this.ma=[],this.fa=i,this.fa.Mo(a=>{r.enqueueAndForget(async()=>{Ur(this)&&(W(cn,"Restarting streams for network reachability change."),await async function(l){const h=oe(l);h.da.add(4),await ji(h),h.ga.set("Unknown"),h.da.delete(4),await Va(h)}(this))})}),this.ga=new _S(r,s)}}async function Va(n){if(Ur(n))for(const e of n.ma)await e(!0)}async function ji(n){for(const e of n.ma)await e(!1)}function rl(n,e){return n.Ea.get(e)||void 0}function Nm(n,e){const t=oe(n),r=rl(t,e.targetId);if(r!==void 0&&t.Ia.has(r))return;const s=function(c,l){const h=rl(c,l);h!==void 0&&c.Ra.delete(h);const d=function(E,S){return S%2!=0?E.Va.next():E.Aa.next()}(c,l);return c.Ea.set(l,d),c.Ra.set(d,l),d}(t,e.targetId);W(cn,"remoteStoreListen mapping SDK target ID to remote",e.targetId,s);const i=new yn(e.target,s,e.purpose,e.sequenceNumber,e.snapshotVersion,e.lastLimboFreeSnapshotVersion,e.resumeToken);t.Ia.set(s,i),ru(t)?nu(t):Ss(t).O_()&&tu(t,i)}function eu(n,e){const t=oe(n),r=Ss(t),s=rl(t,e);W(cn,"remoteStoreUnlisten removing mapping of SDK target ID to remote",e,s),t.Ia.delete(s),t.Ea.delete(e),t.Ra.delete(s),r.O_()&&Om(t,s),t.Ia.size===0&&(r.O_()?r.L_():Ur(t)&&t.ga.set("Unknown"))}function tu(n,e){if(n.pa.$e(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(ie.min())>0){const t=n.Ra.get(e.targetId);if(t===void 0)return void W(cn,"SDK target ID not found for remote ID: "+e.targetId);const r=n.remoteSyncer.getRemoteKeysForTarget(t).size;e=e.withExpectedCount(r)}Ss(n).Z_(e)}function Om(n,e){n.pa.$e(e),Ss(n).X_(e)}function nu(n){n.pa=new hb({getRemoteKeysForTarget:e=>{const t=n.Ra.get(e);return t!==void 0?n.remoteSyncer.getRemoteKeysForTarget(t):pe()},At:e=>n.Ia.get(e)||null,ht:()=>n.datastore.serializer.databaseId}),Ss(n).start(),n.ga.ua()}function ru(n){return Ur(n)&&!Ss(n).x_()&&n.Ia.size>0}function Ur(n){return oe(n).da.size===0}function xm(n){n.pa=void 0}async function ES(n){n.ga.set("Online")}async function vS(n){n.Ia.forEach((e,t)=>{tu(n,e)})}async function TS(n,e){xm(n),ru(n)?(n.ga.ha(e),nu(n)):n.ga.set("Unknown")}async function IS(n,e,t){if(n.ga.set("Online"),e instanceof ym&&e.state===2&&e.cause)try{await async function(s,i){const a=i.cause;for(const c of i.targetIds){if(s.Ia.has(c)){const l=s.Ra.get(c);l!==void 0&&(await s.remoteSyncer.rejectListen(l,a),s.Ea.delete(l),s.Ra.delete(c)),s.Ia.delete(c)}s.pa.removeTarget(c)}}(n,e)}catch(r){W(cn,"Failed to remove targets %s: %s ",e.targetIds.join(","),r),await ta(n,r)}else if(e instanceof Ro?n.pa.Xe(e):e instanceof _m?n.pa.st(e):n.pa.tt(e),!t.isEqual(ie.min()))try{const r=await Vm(n.localStore);t.compareTo(r)>=0&&await function(i,a){const c=i.pa.Tt(a);c.targetChanges.forEach((h,d)=>{if(h.resumeToken.approximateByteSize()>0){const p=i.Ia.get(d);p&&i.Ia.set(d,p.withResumeToken(h.resumeToken,a))}}),c.targetMismatches.forEach((h,d)=>{const p=i.Ia.get(h);if(!p)return;i.Ia.set(h,p.withResumeToken(nt.EMPTY_BYTE_STRING,p.snapshotVersion)),Om(i,h);const E=new yn(p.target,h,d,p.sequenceNumber);tu(i,E)});const l=function(d,p){const E=new Map;p.targetChanges.forEach((V,N)=>{const F=d.Ra.get(N);F!==void 0&&E.set(F,V)});let S=new ke(de);return p.targetMismatches.forEach((V,N)=>{const F=d.Ra.get(V);F!==void 0&&(S=S.insert(F,N))}),new Bi(p.snapshotVersion,E,S,p.documentUpdates,p.resolvedLimboDocuments)}(i,c);return i.remoteSyncer.applyRemoteEvent(l)}(n,t)}catch(r){W(cn,"Failed to raise snapshot:",r),await ta(n,r)}}async function ta(n,e,t){if(!As(e))throw e;n.da.add(1),await ji(n),n.ga.set("Offline"),t||(t=()=>Vm(n.localStore)),n.asyncQueue.enqueueRetryable(async()=>{W(cn,"Retrying IndexedDB access"),await t(),n.da.delete(1),await Va(n)})}function Mm(n,e){return e().catch(t=>ta(n,t,e))}async function Da(n){const e=oe(n),t=sr(e);let r=e.Ta.length>0?e.Ta[e.Ta.length-1].batchId:Ul;for(;wS(e);)try{const s=await rS(e.localStore,r);if(s===null){e.Ta.length===0&&t.L_();break}r=s.batchId,AS(e,s)}catch(s){await ta(e,s)}Lm(e)&&Fm(e)}function wS(n){return Ur(n)&&n.Ta.length<10}function AS(n,e){n.Ta.push(e);const t=sr(n);t.O_()&&t.Y_&&t.ea(e.mutations)}function Lm(n){return Ur(n)&&!sr(n).x_()&&n.Ta.length>0}function Fm(n){sr(n).start()}async function bS(n){sr(n).ra()}async function SS(n){const e=sr(n);for(const t of n.Ta)e.ea(t.mutations)}async function RS(n,e,t){const r=n.Ta.shift(),s=zl.from(r,e,t);await Mm(n,()=>n.remoteSyncer.applySuccessfulWrite(s)),await Da(n)}async function PS(n,e){e&&sr(n).Y_&&await async function(r,s){if(function(a){return cb(a)&&a!==D.ABORTED}(s.code)){const i=r.Ta.shift();sr(r).B_(),await Mm(r,()=>r.remoteSyncer.rejectFailedWrite(i.batchId,s)),await Da(r)}}(n,e),Lm(n)&&Fm(n)}async function rd(n,e){const t=oe(n);t.asyncQueue.verifyOperationInProgress(),W(cn,"RemoteStore received new credentials");const r=Ur(t);t.da.add(3),await ji(t),r&&t.ga.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.da.delete(3),await Va(t)}async function CS(n,e){const t=oe(n);e?(t.da.delete(2),await Va(t)):e||(t.da.add(2),await ji(t),t.ga.set("Unknown"))}function Ss(n){return n.ya||(n.ya=function(t,r,s){const i=oe(t);return i.sa(),new fS(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)}(n.datastore,n.asyncQueue,{Zo:ES.bind(null,n),Yo:vS.bind(null,n),t_:TS.bind(null,n),H_:IS.bind(null,n)}),n.ma.push(async e=>{e?(n.ya.B_(),ru(n)?nu(n):n.ga.set("Unknown")):(await n.ya.stop(),xm(n))})),n.ya}function sr(n){return n.wa||(n.wa=function(t,r,s){const i=oe(t);return i.sa(),new dS(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)}(n.datastore,n.asyncQueue,{Zo:()=>Promise.resolve(),Yo:bS.bind(null,n),t_:PS.bind(null,n),ta:SS.bind(null,n),na:RS.bind(null,n)}),n.ma.push(async e=>{e?(n.wa.B_(),await Da(n)):(await n.wa.stop(),n.Ta.length>0&&(W(cn,`Stopping write stream with ${n.Ta.length} pending writes`),n.Ta=[]))})),n.wa}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Um{constructor(e){this.key=e}}class Bm{constructor(e){this.key=e}}class LS{constructor(e,t){this.query=e,this.tu=t,this.nu=null,this.hasCachedResults=!1,this.current=!1,this.ru=pe(),this.mutatedKeys=pe(),this.iu=im(e),this.su=new hs(this.iu)}get ou(){return this.tu}_u(e,t){const r=t?t.au:new sd,s=t?t.su:this.su;let i=t?t.mutatedKeys:this.mutatedKeys,a=s,c=!1;const l=this.query.limitType==="F"&&s.size===this.query.limit?s.last():null,h=this.query.limitType==="L"&&s.size===this.query.limit?s.first():null;if(e.inorderTraversal((d,p)=>{const E=s.get(d),S=Sa(this.query,p)?p:null,V=!!E&&this.mutatedKeys.has(E.key),N=!!S&&(S.hasLocalMutations||this.mutatedKeys.has(S.key)&&S.hasCommittedMutations);let F=!1;E&&S?E.data.isEqual(S.data)?V!==N&&(r.track({type:3,doc:S}),F=!0):this.uu(E,S)||(r.track({type:2,doc:S}),F=!0,(l&&this.iu(S,l)>0||h&&this.iu(S,h)<0)&&(c=!0)):!E&&S?(r.track({type:0,doc:S}),F=!0):E&&!S&&(r.track({type:1,doc:E}),F=!0,(l||h)&&(c=!0)),F&&(S?(a=a.add(S),i=N?i.add(d):i.delete(d)):(a=a.delete(d),i=i.delete(d)))}),this.query.limit!==null)for(;a.size>this.query.limit;){const d=this.query.limitType==="F"?a.last():a.first();a=a.delete(d.key),i=i.delete(d.key),r.track({type:1,doc:d})}return{su:a,au:r,bs:c,mutatedKeys:i}}uu(e,t){return e.hasLocalMutations&&t.hasCommittedMutations&&!t.hasLocalMutations}applyChanges(e,t,r,s){const i=this.su;this.su=e.su,this.mutatedKeys=e.mutatedKeys;const a=e.au.Da();a.sort((d,p)=>function(S,V){const N=F=>{switch(F){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return ne(20277,{Vt:F})}};return N(S)-N(V)}(d.type,p.type)||this.iu(d.doc,p.doc)),this.cu(r),s=s??!1;const c=t&&!s?this.lu():[],l=this.ru.size===0&&this.current&&!s?1:0,h=l!==this.nu;return this.nu=l,a.length!==0||h?{snapshot:new _s(this.query,e.su,i,a,e.mutatedKeys,l===0,h,!1,!!r&&r.resumeToken.approximateByteSize()>0),hu:c}:{hu:c}}Oa(e){return this.current&&e==="Offline"?(this.current=!1,this.applyChanges({su:this.su,au:new sd,mutatedKeys:this.mutatedKeys,bs:!1},!1)):{hu:[]}}Pu(e){return!this.tu.has(e)&&!!this.su.has(e)&&!this.su.get(e).hasLocalMutations}cu(e){e&&(e.addedDocuments.forEach(t=>this.tu=this.tu.add(t)),e.modifiedDocuments.forEach(t=>{}),e.removedDocuments.forEach(t=>this.tu=this.tu.delete(t)),this.current=e.current)}lu(){if(!this.current)return[];const e=this.ru;this.ru=pe(),this.su.forEach(r=>{this.Pu(r.key)&&(this.ru=this.ru.add(r.key))});const t=[];return e.forEach(r=>{this.ru.has(r)||t.push(new Bm(r))}),this.ru.forEach(r=>{e.has(r)||t.push(new Um(r))}),t}Tu(e){this.tu=e.ks,this.ru=pe();const t=this._u(e.documents);return this.applyChanges(t,!0)}Iu(){return _s.fromInitialDocuments(this.query,this.su,this.mutatedKeys,this.nu===0,this.hasCachedResults)}}const au="SyncEngine";class FS{constructor(e,t,r){this.query=e,this.targetId=t,this.view=r}}class US{constructor(e){this.key=e,this.Eu=!1}}class BS{constructor(e,t,r,s,i,a){this.localStore=e,this.remoteStore=t,this.eventManager=r,this.sharedClientState=s,this.currentUser=i,this.maxConcurrentLimboResolutions=a,this.Ru={},this.Au=new Fr(c=>sm(c),ba),this.Vu=new Map,this.du=new Set,this.mu=new ke(J.comparator),this.fu=new Map,this.gu=new Jl,this.pu={},this.yu=new Map,this.wu=rr.ar(),this.onlineState="Unknown",this.Su=void 0}get isPrimaryClient(){return this.Su===!0}}async function $S(n,e,t=!0){const r=Km(n);let s;const i=r.Au.get(e);return i?(r.sharedClientState.addLocalQueryTarget(i.targetId),s=i.view.Iu()):s=await $m(r,e,t,!0),s}async function jS(n,e){const t=Km(n);await $m(t,e,!0,!1)}async function $m(n,e,t,r){const s=await sS(n.localStore,rn(e)),i=s.targetId,a=n.sharedClientState.addLocalQueryTarget(i,t);let c;return r&&(c=await qS(n,e,i,a==="current",s.resumeToken)),n.isPrimaryClient&&t&&Nm(n.remoteStore,s),c}async function qS(n,e,t,r,s){n.bu=(p,E,S)=>async function(N,F,q,K){let Q=F.view._u(q);Q.bs&&(Q=await Xf(N.localStore,F.query,!1).then(({documents:A})=>F.view._u(A,Q)));const G=K&&K.targetChanges.get(F.targetId),se=K&&K.targetMismatches.get(F.targetId)!=null,he=F.view.applyChanges(Q,N.isPrimaryClient,G,se);return cd(N,F.targetId,he.hu),he.snapshot}(n,p,E,S);const i=await Xf(n.localStore,e,!0),a=new LS(e,i.ks),c=a._u(i.documents),l=$i.createSynthesizedTargetChangeForCurrentChange(t,r&&n.onlineState!=="Offline",s),h=a.applyChanges(c,n.isPrimaryClient,l);cd(n,t,h.hu);const d=new FS(e,t,a);return n.Au.set(e,d),n.Vu.has(t)?n.Vu.get(t).push(e):n.Vu.set(t,[e]),h.snapshot}async function HS(n,e,t){const r=oe(n),s=r.Au.get(e),i=r.Vu.get(s.targetId);if(i.length>1)return r.Vu.set(s.targetId,i.filter(a=>!ba(a,e))),void r.Au.delete(e);r.isPrimaryClient?(r.sharedClientState.removeLocalQueryTarget(s.targetId),r.sharedClientState.isActiveQueryTarget(s.targetId)||await tl(r.localStore,s.targetId,!1).then(()=>{r.sharedClientState.clearQueryState(s.targetId),t&&eu(r.remoteStore,s.targetId),il(r,s.targetId)}).catch(ws)):(il(r,s.targetId),await tl(r.localStore,s.targetId,!0))}async function WS(n,e){const t=oe(n),r=t.Au.get(e),s=t.Vu.get(r.targetId);t.isPrimaryClient&&s.length===1&&(t.sharedClientState.removeLocalQueryTarget(r.targetId),eu(t.remoteStore,r.targetId))}async function KS(n,e,t){const r=ZS(n);try{const s=await function(a,c){const l=oe(a),h=De.now(),d=c.reduce((S,V)=>S.add(V.key),pe());let p,E;return l.persistence.runTransaction("Locally write mutations","readwrite",S=>{let V=bn(),N=pe();return l.xs.getEntries(S,d).next(F=>{V=F,V.forEach((q,K)=>{K.isValidDocument()||(N=N.add(q))})}).next(()=>l.localDocuments.getOverlayedDocuments(S,V)).next(F=>{p=F;const q=[];for(const K of c){const Q=rb(K,p.get(K.key).overlayedDocument);Q!=null&&q.push(new hr(K.key,Q,Jg(Q.value.mapValue),qt.exists(!0)))}return l.mutationQueue.addMutationBatch(S,h,q,c)}).next(F=>{E=F;const q=F.applyToLocalDocumentSet(p,N);return l.documentOverlayCache.saveOverlays(S,F.batchId,q)})}).then(()=>({batchId:E.batchId,changes:am(p)}))}(r.localStore,e);r.sharedClientState.addPendingMutation(s.batchId),function(a,c,l){let h=a.pu[a.currentUser.toKey()];h||(h=new ke(de)),h=h.insert(c,l),a.pu[a.currentUser.toKey()]=h}(r,s.batchId,t),await qi(r,s.changes),await Da(r.remoteStore)}catch(s){const i=iu(s,"Failed to persist write");t.reject(i)}}async function jm(n,e){const t=oe(n);try{const r=await tS(t.localStore,e);e.targetChanges.forEach((s,i)=>{const a=t.fu.get(i);a&&(Ie(s.addedDocuments.size+s.modifiedDocuments.size+s.removedDocuments.size<=1,22616),s.addedDocuments.size>0?a.Eu=!0:s.modifiedDocuments.size>0?Ie(a.Eu,14607):s.removedDocuments.size>0&&(Ie(a.Eu,42227),a.Eu=!1))}),await qi(t,r,e)}catch(r){await ws(r)}}function ad(n,e,t){const r=oe(n);if(r.isPrimaryClient&&t===0||!r.isPrimaryClient&&t===1){const s=[];r.Au.forEach((i,a)=>{const c=a.view.Oa(e);c.snapshot&&s.push(c.snapshot)}),function(a,c){const l=oe(a);l.onlineState=c;let h=!1;l.queries.forEach((d,p)=>{for(const E of p.va)E.Oa(c)&&(h=!0)}),h&&ou(l)}(r.eventManager,e),s.length&&r.Ru.H_(s),r.onlineState=e,r.isPrimaryClient&&r.sharedClientState.setOnlineState(e)}}async function zS(n,e,t){const r=oe(n);r.sharedClientState.updateQueryState(e,"rejected",t);const s=r.fu.get(e),i=s&&s.key;if(i){let a=new ke(J.comparator);a=a.insert(i,ct.newNoDocument(i,ie.min()));const c=pe().add(i),l=new Bi(ie.min(),new Map,new ke(de),a,c);await jm(r,l),r.mu=r.mu.remove(i),r.fu.delete(e),cu(r)}else await tl(r.localStore,e,!1).then(()=>il(r,e,t)).catch(ws)}async function GS(n,e){const t=oe(n),r=e.batch.batchId;try{const s=await eS(t.localStore,e);Hm(t,r,null),qm(t,r),t.sharedClientState.updateMutationState(r,"acknowledged"),await qi(t,s)}catch(s){await ws(s)}}async function QS(n,e,t){const r=oe(n);try{const s=await function(a,c){const l=oe(a);return l.persistence.runTransaction("Reject batch","readwrite-primary",h=>{let d;return l.mutationQueue.lookupMutationBatch(h,c).next(p=>(Ie(p!==null,37113),d=p.keys(),l.mutationQueue.removeMutationBatch(h,p))).next(()=>l.mutationQueue.performConsistencyCheck(h)).next(()=>l.documentOverlayCache.removeOverlaysForBatchId(h,d,c)).next(()=>l.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(h,d)).next(()=>l.localDocuments.getDocuments(h,d))})}(r.localStore,e);Hm(r,e,t),qm(r,e),r.sharedClientState.updateMutationState(e,"rejected",t),await qi(r,s)}catch(s){await ws(s)}}function qm(n,e){(n.yu.get(e)||[]).forEach(t=>{t.resolve()}),n.yu.delete(e)}function Hm(n,e,t){const r=oe(n);let s=r.pu[r.currentUser.toKey()];if(s){const i=s.get(e);i&&(t?i.reject(t):i.resolve(),s=s.remove(e)),r.pu[r.currentUser.toKey()]=s}}function il(n,e,t=null){n.sharedClientState.removeLocalQueryTarget(e);for(const r of n.Vu.get(e))n.Au.delete(r),t&&n.Ru.Du(r,t);n.Vu.delete(e),n.isPrimaryClient&&n.gu.Gr(e).forEach(r=>{n.gu.containsKey(r)||Wm(n,r)})}function Wm(n,e){n.du.delete(e.path.canonicalString());const t=n.mu.get(e);t!==null&&(eu(n.remoteStore,t),n.mu=n.mu.remove(e),n.fu.delete(t),cu(n))}function cd(n,e,t){for(const r of t)r instanceof Um?(n.gu.addReference(r.key,e),JS(n,r)):r instanceof Bm?(W(au,"Document no longer in limbo: "+r.key),n.gu.removeReference(r.key,e),n.gu.containsKey(r.key)||Wm(n,r.key)):ne(19791,{Cu:r})}function JS(n,e){const t=e.key,r=t.path.canonicalString();n.mu.get(t)||n.du.has(r)||(W(au,"New document in limbo: "+t),n.du.add(r),cu(n))}function cu(n){for(;n.du.size>0&&n.mu.size<n.maxConcurrentLimboResolutions;){const e=n.du.values().next().value;n.du.delete(e);const t=new J(Pe.fromString(e)),r=n.wu.next();n.fu.set(r,new US(t)),n.mu=n.mu.insert(t,r),Nm(n.remoteStore,new yn(rn(Hl(t.path)),r,"TargetPurposeLimboResolution",Ia.ce))}}async function qi(n,e,t){const r=oe(n),s=[],i=[],a=[];r.Au.isEmpty()||(r.Au.forEach((c,l)=>{a.push(r.bu(l,e,t).then(h=>{var d;if((h||t)&&r.isPrimaryClient){const p=h?!h.fromCache:(d=t==null?void 0:t.targetChanges.get(l.targetId))==null?void 0:d.current;r.sharedClientState.updateQueryState(l.targetId,p?"current":"not-current")}if(h){s.push(h);const p=Xl.Es(l.targetId,h);i.push(p)}}))}),await Promise.all(a),r.Ru.H_(s),await async function(l,h){const d=oe(l);try{await d.persistence.runTransaction("notifyLocalViewChanges","readwrite",p=>k.forEach(h,E=>k.forEach(E.Ts,S=>d.persistence.referenceDelegate.addReference(p,E.targetId,S)).next(()=>k.forEach(E.Is,S=>d.persistence.referenceDelegate.removeReference(p,E.targetId,S)))))}catch(p){if(!As(p))throw p;W(Zl,"Failed to update sequence numbers: "+p)}for(const p of h){const E=p.targetId;if(!p.fromCache){const S=d.vs.get(E),V=S.snapshotVersion,N=S.withLastLimboFreeSnapshotVersion(V);d.vs=d.vs.insert(E,N)}}}(r.localStore,i))}async function YS(n,e){const t=oe(n);if(!t.currentUser.isEqual(e)){W(au,"User change. New user:",e.toKey());const r=await Cm(t.localStore,e);t.currentUser=e,function(i,a){i.yu.forEach(c=>{c.forEach(l=>{l.reject(new z(D.CANCELLED,a))})}),i.yu.clear()}(t,"'waitForPendingWrites' promise is rejected due to a user change."),t.sharedClientState.handleUserChange(e,r.removedBatchIds,r.addedBatchIds),await qi(t,r.Ns)}}function XS(n,e){const t=oe(n),r=t.fu.get(e);if(r&&r.Eu)return pe().add(r.key);{let s=pe();const i=t.Vu.get(e);if(!i)return s;for(const a of i){const c=t.Au.get(a);s=s.unionWith(c.view.ou)}return s}}function Km(n){const e=oe(n);return e.remoteStore.remoteSyncer.applyRemoteEvent=jm.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=XS.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=zS.bind(null,e),e.Ru.H_=OS.bind(null,e.eventManager),e.Ru.Du=xS.bind(null,e.eventManager),e}function ZS(n){const e=oe(n);return e.remoteStore.remoteSyncer.applySuccessfulWrite=GS.bind(null,e),e.remoteStore.remoteSyncer.rejectFailedWrite=QS.bind(null,e),e}class na{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(e){this.serializer=Ca(e.databaseInfo.databaseId),this.sharedClientState=this.Mu(e),this.persistence=this.xu(e),await this.persistence.start(),this.localStore=this.Ou(e),this.gcScheduler=this.Nu(e,this.localStore),this.indexBackfillerScheduler=this.Bu(e,this.localStore)}Nu(e,t){return null}Bu(e,t){return null}Ou(e){return Zb(this.persistence,new Jb,e.initialUser,this.serializer)}xu(e){return new Pm(Yl.Vi,this.serializer)}Mu(e){return new oS}async terminate(){var e,t;(e=this.gcScheduler)==null||e.stop(),(t=this.indexBackfillerScheduler)==null||t.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}na.provider={build:()=>new na};class eR extends na{constructor(e){super(),this.cacheSizeBytes=e}Nu(e,t){Ie(this.persistence.referenceDelegate instanceof ea,46915);const r=this.persistence.referenceDelegate.garbageCollector;return new xb(r,e.asyncQueue,t)}xu(e){const t=this.cacheSizeBytes!==void 0?vt.withCacheSize(this.cacheSizeBytes):vt.DEFAULT;return new Pm(r=>ea.Vi(r,t),this.serializer)}}class ol{async initialize(e,t){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(t),this.remoteStore=this.createRemoteStore(t),this.eventManager=this.createEventManager(t),this.syncEngine=this.createSyncEngine(t,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=r=>ad(this.syncEngine,r,1),this.remoteStore.remoteSyncer.handleCredentialChange=YS.bind(null,this.syncEngine),await CS(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return function(){return new DS}()}createDatastore(e){const t=Ca(e.databaseInfo.databaseId),r=hS(e.databaseInfo);return mS(e.authCredentials,e.appCheckCredentials,r,t)}createRemoteStore(e){return function(r,s,i,a,c){return new yS(r,s,i,a,c)}(this.localStore,this.datastore,e.asyncQueue,t=>ad(this.syncEngine,t,0),function(){return td.v()?new td:new aS}())}createSyncEngine(e,t){return function(s,i,a,c,l,h,d){const p=new BS(s,i,a,c,l,h);return d&&(p.Su=!0),p}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,t)}async terminate(){var e,t;await async function(s){const i=oe(s);W(cn,"RemoteStore shutting down."),i.da.add(5),await ji(i),i.fa.shutdown(),i.ga.set("Unknown")}(this.remoteStore),(e=this.datastore)==null||e.terminate(),(t=this.eventManager)==null||t.terminate()}}ol.provider={build:()=>new ol};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ot{constructor(e){this._byteString=e}static fromBase64String(e){try{return new Ot(nt.fromBase64String(e))}catch(t){throw new z(D.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new Ot(nt.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}toJSON(){return{type:Ot._jsonSchemaVersion,bytes:this.toBase64()}}static fromJSON(e){if(Fi(e,Ot._jsonSchema))return Ot.fromBase64String(e.bytes)}}Ot._jsonSchemaVersion="firestore/bytes/1.0",Ot._jsonSchema={type:Be("string",Ot._jsonSchemaVersion),bytes:Be("string")};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class on{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new z(D.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new z(D.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return de(this._lat,e._lat)||de(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:on._jsonSchemaVersion}}static fromJSON(e){if(Fi(e,on._jsonSchema))return new on(e.latitude,e.longitude)}}on._jsonSchemaVersion="firestore/geoPoint/1.0",on._jsonSchema={type:Be("string",on._jsonSchemaVersion),latitude:Be("number"),longitude:Be("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ht{constructor(e){this._values=(e||[]).map(t=>t)}toArray(){return this._values.map(e=>e)}isEqual(e){return function(r,s){if(r.length!==s.length)return!1;for(let i=0;i<r.length;++i)if(r[i]!==s[i])return!1;return!0}(this._values,e._values)}toJSON(){return{type:Ht._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(e){if(Fi(e,Ht._jsonSchema)){if(Array.isArray(e.vectorValues)&&e.vectorValues.every(t=>typeof t=="number"))return new Ht(e.vectorValues);throw new z(D.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}}Ht._jsonSchemaVersion="firestore/vectorValue/1.0",Ht._jsonSchema={type:Be("string",Ht._jsonSchemaVersion),vectorValues:Be("object")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Kn(DR,kR,"app");const NR={apiKey:"AIzaSyAWJiDPnggMGmFl3LA6dp1ImaeEoa9oLJk",authDomain:"task-list-76460.firebaseapp.com",projectId:"task-list-76460",storageBucket:"task-list-76460.firebasestorage.app",messagingSenderId:"357470215566",appId:"1:357470215566:web:37e6f0cb3e31275fd998df"},a_=zp(NR),sa=eA(a_),Kr=uR(a_),OR={class:"auth-container"},xR={class:"auth-card"},MR={class:"form-group"},LR={class:"form-group"},FR={key:0,class:"error-message"},UR=["disabled"],BR={class:"toggle-text"},$R=cp({__name:"AuthForm",setup(n){const e=Fe(""),t=Fe(""),r=Fe(!0),s=Fe(""),i=Fe(!1),a=async()=>{if(!(!e.value||!t.value)){i.value=!0,s.value="";try{r.value?await UI(sa,e.value,t.value):await FI(sa,e.value,t.value)}catch(l){const h=l.code??"";s.value=c(h)}finally{i.value=!1}}},c=l=>({"auth/user-not-found":"メールアドレスが見つかりません","auth/wrong-password":"パスワードが正しくありません","auth/invalid-credential":"メールアドレスまたはパスワードが正しくありません","auth/email-already-in-use":"このメールアドレスは既に使用されています","auth/weak-password":"パスワードは6文字以上にしてください","auth/invalid-email":"メールアドレスの形式が正しくありません","auth/too-many-requests":"ログイン試行が多すぎます。しばらく後に再試行してください"})[l]??"エラーが発生しました。再試行してください";return(l,h)=>(yt(),kt("div",OR,[ee("div",xR,[h[5]||(h[5]=ee("h1",null,"📝 Todoリスト",-1)),ee("h2",null,Bt(r.value?"ログイン":"アカウント作成"),1),ee("form",{onSubmit:yo(a,["prevent"])},[ee("div",MR,[h[3]||(h[3]=ee("label",{for:"email"},"メールアドレス",-1)),No(ee("input",{id:"email","onUpdate:modelValue":h[0]||(h[0]=d=>e.value=d),type:"email",placeholder:"example@email.com",required:"",autocomplete:"email"},null,512),[[Uo,e.value]])]),ee("div",LR,[h[4]||(h[4]=ee("label",{for:"password"},"パスワード",-1)),No(ee("input",{id:"password","onUpdate:modelValue":h[1]||(h[1]=d=>t.value=d),type:"password",placeholder:"6文字以上",required:"",autocomplete:"current-password"},null,512),[[Uo,t.value]])]),s.value?(yt(),kt("p",FR,Bt(s.value),1)):Ar("",!0),ee("button",{type:"submit",disabled:i.value,class:"submit-btn"},Bt(i.value?"処理中...":r.value?"ログイン":"登録"),9,UR)],32),ee("p",BR,[kp(Bt(r.value?"アカウントをお持ちでない方は":"すでにアカウントをお持ちの方は")+" ",1),ee("button",{class:"link-btn",onClick:h[2]||(h[2]=d=>{r.value=!r.value,s.value=""})},Bt(r.value?"新規登録":"ログイン"),1)])])]))}}),c_=(n,e)=>{const t=n.__vccOpts||n;for(const[r,s]of e)t[r]=s;return t},jR=c_($R,[["__scopeId","data-v-304ef8ac"]]),qR={key:0,class:"loading-screen"},HR={key:2,class:"todo-app"},WR={class:"sticky-top"},KR={class:"app-header"},zR={class:"user-info"},GR={class:"user-email"},QR={class:"progress-section"},JR={class:"progress-labels"},YR={class:"progress-labels-left"},XR=["title"],ZR={class:"progress-bar-track"},eP={key:0,class:"notification-banner"},tP={class:"todo-list"},nP=["onClick"],rP=["checked","onChange"],sP={class:"todo-text"},iP={key:0,class:"empty-message"},oP={class:"add-panel-actions"},aP=["disabled"],cP={class:"add-panel-actions edit-panel-actions"},lP=["disabled"],bd=100,uP=cp({__name:"App",setup(n){const e=Fe(null),t=Fe(!0),r=Fe([]),s=Fe(""),i=Fe(!1),a=Fe("unsupported"),c=Fe(0),l=Fe(!1),h=Fe(!1);let d=0;const p=Gr(()=>h.value?{transform:"translateY(100%)",transition:"transform 0.3s cubic-bezier(0.32, 0.72, 0, 1)"}:l.value?{transform:`translateY(${c.value}px)`,transition:"none"}:{transform:`translateY(${c.value}px)`,transition:"transform 0.3s cubic-bezier(0.32, 0.72, 0, 1)"}),E=le=>{d=le.touches[0].clientY,c.value=0,l.value=!0},S=le=>{if(!l.value)return;const ae=le.touches[0].clientY-d;c.value=Math.max(0,ae)},V=()=>{c.value>bd?(l.value=!1,h.value=!0,setTimeout(()=>{h.value=!1,c.value=0,Ct()},300)):(l.value=!1,Sc(()=>{c.value=0}))},N=Fe(!1),F=Fe(null),q=Fe(""),K=Fe(0),Q=Fe(!1),G=Fe(!1);let se=0;const he=Gr(()=>G.value?{transform:"translateY(100%)",transition:"transform 0.3s cubic-bezier(0.32, 0.72, 0, 1)"}:Q.value?{transform:`translateY(${K.value}px)`,transition:"none"}:{transform:`translateY(${K.value}px)`,transition:"transform 0.3s cubic-bezier(0.32, 0.72, 0, 1)"}),A=le=>{se=le.touches[0].clientY,K.value=0,Q.value=!0},y=le=>{if(!Q.value)return;const ae=le.touches[0].clientY-se;K.value=Math.max(0,ae)},m=()=>{K.value>bd?(Q.value=!1,G.value=!0,setTimeout(()=>{G.value=!1,K.value=0,Ke()},300)):(Q.value=!1,Sc(()=>{K.value=0}))};let w=null;const I=Gr(()=>r.value.filter(le=>le.completed).length),T=Gr(()=>r.value.filter(le=>!le.completed).length),_=Gr(()=>r.value.length===0?0:Math.round(I.value/r.value.length*100)),me=le=>{"setAppBadge"in navigator&&(le>0?navigator.setAppBadge(le):navigator.clearAppBadge())};go(T,me,{immediate:!0});const je=le=>{const ae=pd(Kr,"users",le,"todos"),ze=AR(ae,bR("createdAt","asc"));w=CR(ze,v=>{r.value=v.docs.map(b=>({id:b.id,text:b.data().text,completed:b.data().completed}))})},Ne=async()=>{!e.value||s.value.trim()===""||(await PR(pd(Kr,"users",e.value.uid,"todos"),{text:s.value.trim(),completed:!1,createdAt:TR()}),s.value="",i.value=!1)},Ae=async le=>{e.value&&await Ad(Ys(Kr,"users",e.value.uid,"todos",le))},ye=le=>{F.value=le,q.value=le.text,K.value=0,Q.value=!1,G.value=!1,N.value=!0},Ke=()=>{N.value=!1,F.value=null,q.value="",K.value=0,Q.value=!1},ln=async()=>{!e.value||!F.value||q.value.trim()===""||(await wd(Ys(Kr,"users",e.value.uid,"todos",F.value.id),{text:q.value.trim()}),Ke())},Pt=async()=>{!e.value||!F.value||(await Ae(F.value.id),Ke())},ft=async()=>{if(!e.value)return;const le=r.value.filter(ae=>ae.completed);await Promise.all(le.map(ae=>Ad(Ys(Kr,"users",e.value.uid,"todos",ae.id))))},fr=async le=>{if(!e.value)return;const ae=r.value.find(ze=>ze.id===le);ae&&await wd(Ys(Kr,"users",e.value.uid,"todos",le),{completed:!ae.completed})},Pn=async()=>{await qI(sa)},dr=async()=>{if("Notification"in window)if(Notification.permission==="default"){const le=await Notification.requestPermission();a.value=le,le==="granted"&&me(T.value)}else a.value=Notification.permission},Lt=()=>{i.value=!0,s.value="",c.value=0,l.value=!1,h.value=!1},Ct=()=>{i.value=!1,s.value="",c.value=0,l.value=!1};let Vt=null;return Tl(()=>{"Notification"in window&&(a.value=Notification.permission),Vt=jI(sa,le=>{e.value=le,t.value=!1,w&&(w(),w=null,r.value=[]),le&&(je(le.uid),dr())})}),Il(()=>{Vt==null||Vt(),w==null||w(),"clearAppBadge"in navigator&&navigator.clearAppBadge()}),(le,ae)=>t.value?(yt(),kt("div",qR,[...ae[4]||(ae[4]=[ee("p",null,"読み込み中...",-1)])])):e.value?(yt(),kt("div",HR,[ee("div",WR,[ee("header",KR,[ae[5]||(ae[5]=ee("h1",null,"Todoリスト",-1)),ee("div",zR,[ee("span",GR,Bt(e.value.email),1),ee("button",{class:"logout-btn",onClick:Pn},"ログアウト")])]),ee("div",QR,[ee("div",JR,[ee("div",YR,[I.value>0?(yt(),kt("button",{key:0,class:"delete-completed-btn",onClick:ft,title:`チェック済み ${I.value} 件を削除`},"完了済みを削除",8,XR)):Ar("",!0),ee("span",null,"進捗 "+Bt(_.value)+"%",1)]),ee("span",null,Bt(I.value)+" / "+Bt(r.value.length)+" 完了",1)]),ee("div",ZR,[ee("div",{class:"progress-bar-fill",style:rs({width:_.value+"%"})},null,4)])]),a.value==="denied"?(yt(),kt("div",eP," バッジを表示するには、設定 › Safari › 通知 で許可してください ")):Ar("",!0)]),ee("div",tP,[(yt(!0),kt(Ut,null,My(r.value,ze=>(yt(),kt("div",{key:ze.id,class:la(["todo-item",{completed:ze.completed}]),onClick:v=>ye(ze)},[ee("span",{onClick:ae[0]||(ae[0]=yo(()=>{},["stop"]))},[ee("input",{type:"checkbox",checked:ze.completed,onChange:v=>fr(ze.id)},null,40,rP)]),ee("span",sP,Bt(ze.text),1)],10,nP))),128)),r.value.length===0?(yt(),kt("p",iP," タスクがありません。＋ボタンで追加してください。 ")):Ar("",!0)]),ee("button",{class:"fab",onClick:Lt,"aria-label":"タスクを追加"},[...ae[6]||(ae[6]=[ee("span",{class:"fab-icon"},"＋",-1)])]),lt(sc,{name:"fade"},{default:fo(()=>[i.value||N.value?(yt(),kt("div",{key:0,class:"overlay",onClick:ae[1]||(ae[1]=ze=>i.value?Ct():Ke())})):Ar("",!0)]),_:1}),lt(sc,{name:h.value?"":"slide-up"},{default:fo(()=>[i.value?(yt(),kt("div",{key:0,class:"add-panel",style:rs(p.value),onTouchstart:E,onTouchmove:yo(S,["prevent"]),onTouchend:V},[ae[8]||(ae[8]=ee("div",{class:"add-panel-handle"},null,-1)),ee("div",{class:"add-panel-header"},[ee("button",{class:"close-btn",onClick:Ct,"aria-label":"閉じる"},"✕"),ae[7]||(ae[7]=ee("h2",{class:"add-panel-title"},"タスクを追加",-1))]),No(ee("input",{"onUpdate:modelValue":ae[2]||(ae[2]=ze=>s.value=ze),type:"text",class:"add-panel-input",placeholder:"新しいタスクを入力...",onKeyup:qh(Ne,["enter"]),autofocus:""},null,544),[[Uo,s.value]]),ee("div",oP,[ee("button",{class:"add-btn",onClick:Ne,disabled:s.value.trim()===""},"追加",8,aP)])],36)):Ar("",!0)]),_:1},8,["name"]),lt(sc,{name:G.value?"":"slide-up"},{default:fo(()=>[N.value?(yt(),kt("div",{key:0,class:"add-panel",style:rs(he.value),onTouchstart:A,onTouchmove:yo(y,["prevent"]),onTouchend:m},[ae[10]||(ae[10]=ee("div",{class:"add-panel-handle"},null,-1)),ee("div",{class:"add-panel-header"},[ee("button",{class:"close-btn",onClick:Ke,"aria-label":"閉じる"},"✕"),ae[9]||(ae[9]=ee("h2",{class:"add-panel-title"},"タスクを編集",-1))]),No(ee("input",{"onUpdate:modelValue":ae[3]||(ae[3]=ze=>q.value=ze),type:"text",class:"add-panel-input",placeholder:"タスクを入力...",onKeyup:qh(ln,["enter"]),autofocus:""},null,544),[[Uo,q.value]]),ee("div",cP,[ee("button",{class:"delete-btn edit-delete-btn",onClick:Pt},"削除"),ee("button",{class:"add-btn",onClick:ln,disabled:q.value.trim()===""},"保存",8,lP)])],36)):Ar("",!0)]),_:1},8,["name"])])):(yt(),Vp(jR,{key:1}))}}),hP=c_(uP,[["__scopeId","data-v-086cf2e4"]]);rv(hP).mount("#app");
